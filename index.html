...
<body>
	...
	<div class="jumbotron mb-0 pt-5 pb-5">
        <div class="container">
	...
	<div class="container mt-5 mb-5">
		...
		<div class="row mb-5 text-center">
			<div class="col-md-12"><h2>Features</h2></div>
		</div>
	...
	<div class="container-fluid bg-light pt-4 pb-2">
		<div class="row">
			<div class="col-md-12 text-center font-weight-bold">
				<p>© jsnav.com all right reserved.</p>
			</div>
		</div>
	</div>

	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
	<script src="js/menu.js"></script> <!-- jsnav navigation jQuery -->
